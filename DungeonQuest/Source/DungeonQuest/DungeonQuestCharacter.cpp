...
#include "DungeonQuestCharacter.h"
...
void ADungeonQuestCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	// Set up action bindings
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		// Jumping
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Started, this, &ADungeonQuestCharacter::DoJumpStart);
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Completed, this, &ADungeonQuestCharacter::DoJumpEnd);

		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADungeonQuestCharacter::MoveInput);
...
void ADungeonQuestCharacter::MoveInput(const FInputActionValue& Value)
{
...
void ADungeonQuestCharacter::DoMove(float Right, float Forward)
{
	if (GetController())
	{
...
void ADungeonQuestCharacter::DoJumpStart()
{
	// pass Jump to the character
	Jump();
}

void ADungeonQuestCharacter::DoJumpEnd()
{
